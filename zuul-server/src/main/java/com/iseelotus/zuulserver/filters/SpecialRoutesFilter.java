...
import com.iseelotus.zuulserver.models.AbTestingRoute;
...
public class SpecialRoutesFilter extends ZuulFilter {
    ...
    public Object run() throws ZuulException {
        ...
        if (abTestingRoute != null && useSpecialRoute(abTestingRoute)) {
            String route = buildRouteString(context.getRequest().getRequestURI(),
    ...
    private AbTestingRoute getAbTestingRoute(String serviceId) {
        ResponseEntity<AbTestingRoute> restExchange;
        try {
            restExchange = restTemplate.exchange(
                    "http://specialroutes-service/v1/route/ab-testing/{serviceId}",
                    HttpMethod.GET,
                    null,
